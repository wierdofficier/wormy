...
#include "noise.h"
int totaln[26576*2] ;
int ptreeonce_fluid= 1;
int ptreeonce_fluid1 = 1;
int c_m = 0;
int cm2 = 0;
double pos_[3];
double oldpos[3];
...
int k_flappers = 0;
int INDEX_p[26576*2];
double time_particle[26576*2];
double dist__first[26576*2];
double posdiff[2][26576*2];
double veldiff[2][26576*2];
double dist__next[26576*2];
int time_activate[26576*2]  ;
...
double  neighbourV_[60000*2][100] ;
double  neighbourV_m[1000][100] ;
double  neighbourV_water[26576*2][100] ;
double neigbours_wall_xyz[10000][100][4];
int neigbours_wall[26576*2][400];
 double acc2_fluid[3][60000 ][1][250] ;
double water_radius = 3.00002;
int alloc_once = 1;
...
float dNear = 100;
float dFar = 2000;
double F_total[3][SIZE_OBJECT*2][1][250] ;
int totalneigbours[SIZE_OBJECT*4][HOW_MANY_FLUIDS] ;
...
int state_result_worm_ventral_feather[SIZE_OBJECT*2 ][SIZE_OBJECT][2];
...
void taskworm(int howmanyfluids, int kkkkkkkk, int xxx )
{
 ...
 findnearestpoint_fluid(SIZE_OBJECT  ,NULL,llll,1,0,xxx );
...
if(acc1once == 0)
	{
		if(fabs(acc1) > 0)
		{		
			springConstant =   25.205;
 
			frictionConstant =   .000202;
		}
	}
	acc1once = 0;	
 	springConstant =   25.205;
 
			frictionConstant =   .2000202;
...
k_flappers = xxx;		
 calc_fluid_velocity(INDEX_NR,howmanyfluids,xxx );
 
calc_fluid_acceleration(INDEX_NR,howmanyfluids,xxx,xxx);
 ...
 calc_fluid_velocity(llll,howmanyfluids,xxx );
 
calc_fluid_acceleration(llll,howmanyfluids,k,k);
  ...
  glutPostRedisplay(); 
	...
	{	 
		...
		if(fabs(F_total[0][INDEX_NRmore][howmanyfluids][d]) > 21 )
	 				  F_total[0][INDEX_NRmore][howmanyfluids][d] =0;
 
		if(fabs(F_total[1][INDEX_NRmore][howmanyfluids][d])  > 21)
					  F_total[1][INDEX_NRmore][howmanyfluids][d] =0;

		if(fabs(F_total[2][INDEX_NRmore][howmanyfluids][d])  > 21)
					  F_total[2][INDEX_NRmore][howmanyfluids][d] =0;
	  	

 		if(fabs(F_total[0][INDEX_NR][howmanyfluids][d]) > 21 )
	 				  F_total[0][INDEX_NR][howmanyfluids][d] =0;
 
		if(fabs(F_total[1][INDEX_NR][howmanyfluids][d])  > 21)
					  F_total[1][INDEX_NR][howmanyfluids][d] =0;

		if(fabs(F_total[2][INDEX_NR][howmanyfluids][d])  > 21)
					  F_total[2][INDEX_NR][howmanyfluids][d] =0;
   
		springVector->pos_new_x = state_result_worm_ventral[INDEX_NR][d][howmanyfluids].pos_new_x - state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].pos_new_x;
		springVector->pos_new_y = state_result_worm_ventral[INDEX_NR][d][howmanyfluids].pos_new_y - state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].pos_new_y;
		springVector->pos_new_z = state_result_worm_ventral[INDEX_NR][d][howmanyfluids].pos_new_z - state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].pos_new_z;
 
 
		float r = length(state_result_worm_ventral[INDEX_NR][d][howmanyfluids],state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids]);
 
		if ( r != 0  &&    (r) < 1.1    )
		{	
 
			F_total[0][INDEX_NR][howmanyfluids][d] +=( springVector->pos_new_x  /  r ) * ( r - springlength ) * ( -springConstant );
			F_total[1][INDEX_NR][howmanyfluids][d] += ( springVector->pos_new_y /  r ) * ( r - springlength ) * ( -springConstant );
			F_total[2][INDEX_NR][howmanyfluids][d] +=( springVector->pos_new_z  /  r ) * ( r - springlength ) * ( -springConstant );

			F_total[0][INDEX_NRmore][howmanyfluids][d] +=( springVector->pos_new_x  / r ) * ( r - springlength ) * ( -springConstant );
			F_total[1][INDEX_NRmore][howmanyfluids][d] += ( springVector->pos_new_y  / r ) * ( r - springlength) * ( -springConstant );
			F_total[2][INDEX_NRmore][howmanyfluids][d] +=( springVector->pos_new_z  / r ) * ( r - springlength ) * ( -springConstant );

			F_total[0][INDEX_NR][howmanyfluids][d] +=-(  state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_x - state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_x ) * frictionConstant;
 			F_total[1][INDEX_NR][howmanyfluids][d] += -( state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_y- state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_y ) * frictionConstant;
 			F_total[2][INDEX_NR][howmanyfluids][d] += -(  state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_z - state_result_worm_ventral[INDEX_NRmore ][d][howmanyfluids].vel_new_z ) * frictionConstant;

 
			F_total[0][INDEX_NRmore][howmanyfluids][d] +=-(  state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_x - state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_x ) * frictionConstant;
 			F_total[1][INDEX_NRmore][howmanyfluids][d] += -( state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_y- state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_y ) * frictionConstant;
 			F_total[2][INDEX_NRmore][howmanyfluids][d] += -(  state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_z - state_result_worm_ventral[INDEX_NRmore ][d][howmanyfluids].vel_new_z ) * frictionConstant;

		/* state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_x = state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_x*0.9999 ;
		
		state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_y = state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_y*0.9999 ;

		state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_z = state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].vel_new_z*0.9999 ;

		state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_x = state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_x*0.9999 ;
		
		state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_y = state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_y*0.9999 ;
		state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_z = state_result_worm_ventral[INDEX_NR][d][howmanyfluids].vel_new_z*0.9999 ; */ 
		}

k_flappers = d;
 calc_fluid_velocity(INDEX_NR,howmanyfluids,d);
 
calc_fluid_acceleration(INDEX_NR,howmanyfluids,d,d);
		state_result_worm_ventral[INDEX_NR][d][howmanyfluids].force_sign =  -1;
		state_result_worm_ventral[INDEX_NR][d][howmanyfluids]    =  worm_ventral(   state_result_worm_ventral[INDEX_NR][d][howmanyfluids] ,1) ;
   glutPostRedisplay(); 

 calc_fluid_velocity(INDEX_NRmore,howmanyfluids,d);
 
calc_fluid_acceleration(INDEX_NRmore,howmanyfluids,d,d);
		state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids].force_sign =   1; ; 
		state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids]    =  worm_ventral(   state_result_worm_ventral[INDEX_NRmore][d][howmanyfluids] ,1);
  glutPostRedisplay(); 
 	} 		 
 }	
...
int find_index_____fluid(int NUM, double *pos   ,int num,int k, int howm,int kk )
{
int ll = 0;
 	while(ll < NUM)
	{

		if(state_result_worm_ventral[ll][howm][kk].pos_new_x ==pos[0] && state_result_worm_ventral[ll][howm][kk].pos_new_y ==pos[1]  && state_result_worm_ventral[ll][howm][kk].pos_new_z ==pos[2] )
		{
...
int findnearestpoint_fluid(int points,struct state_vector     *worm , int num,int howmany,int kk, int xxx) {
	...
	double pt[3];
void *ptree_fluid;
	pt[0] = state_result_worm_ventral[num][xxx][kk].pos_new_x;
	pt[1] = state_result_worm_ventral[num][xxx][kk].pos_new_y;
	pt[2] = state_result_worm_ventral[num][xxx][kk].pos_new_z;
	double radius = 0.07;
	...
	srand( time(0) );
 	...
 	ptree_fluid = kd_create( 3 );
if(ptreeonce_fluid == 0 || ptreeonce_fluid1 == 1)
{
  	for( i=0; i<points; i++ ) {   
    		assert( 0 == kd_insert3( ptree_fluid,  state_result_worm_ventral[i][xxx][kk].pos_new_x,  state_result_worm_ventral[i][xxx][kk].pos_new_y,  state_result_worm_ventral[i][xxx][kk].pos_new_z, NULL ) );
 	 }
ptreeonce_fluid1 = 0;
 }
 ...
 totalneigbours[num][kk] = kd_res_size(presults);
 printf("totalneigbours[num][0] = %d \n", totalneigbours[num][kk]);
	int feather_count = 0;
...
while( !kd_res_end( presults ) ) {
	 ...
	 int k;
 	 ...
 	 INDEX = find_index_____fluid(points,pos,num,feather_count,xxx,kk);
 
  	 
 state_result_worm_ventral_feather[num][feather_count][kk]  = INDEX;
 ...
 int kk = 0;
		...
		for(ll = 0; ll < SIZE_OBJECT  ; ll+=1       )
		{
		  ...
		  v= (Vec3 *)(V + 3*(KvvVENTALA[ll]-1));
         	  state_result_worm_ventral[c_m][0][kk].pos_new_x = v->x ;
 
 	          state_result_worm_ventral[c_m][0][kk].pos_new_y = v->y + 13.4 ;
 		  state_result_worm_ventral[c_m][0][kk].pos_new_z = v->z ;
 
 	  	  state_result_worm_ventral[c_m][0][kk].vel_new_x = 64.04;
 		  state_result_worm_ventral[c_m][0][kk].vel_new_y = -0;
 		  state_result_worm_ventral[c_m][0][kk].vel_new_z =  0 ;
totalneigbours[c_m][0] =1;
c_m++;
 	...
 	for(ll = 0; ll < SIZE_OBJECT  ; ll+=1       )
		{
		  ...
		  v= (Vec3 *)(V + 3*(KvvVENTALA[ll]-1));
         	  state_result_worm_ventral[c_m][0][kk].pos_new_x = v->x +  13.4 ;
 
 	          state_result_worm_ventral[c_m][0][kk].pos_new_y = v->y + 0;
 		  state_result_worm_ventral[c_m][0][kk].pos_new_z = v->z ;
 
 	  	  state_result_worm_ventral[c_m][0][kk].vel_new_x = 6.04;
 		  state_result_worm_ventral[c_m][0][kk].vel_new_y = 0;
 		  state_result_worm_ventral[c_m][0][kk].vel_new_z =  2.1 ;
...
for(int ll = 0; ll < c_m; ll++ )
	{
 		...
 		findnearestpoint_fluid(SIZE_OBJECT  ,NULL,ll,1,kk,0 );
}
...
cool_once = 0;
 ...
 //	  {
 int kk = 0;
double color[12] = {1.0, 0.0, 1.0,0.0 ,1.0 ,0.0,1.0 ,1.0, 0.0,1.0, 1.0, 1.0  };
  //for(int kk = 0; kk <  1; kk++)  
	// {
  //   kk = 0; 
 ...
 int INDEX_NR___ =    ll;//  state_result_worm_ventral_feather[ll][xx][kk]  ;
 

      
 

  taskworm(kk,INDEX_NR___,xx);
       glPushMatrix();
...
// glColor3f(color[kk*3+0],color[kk*3+1],color[kk*3+2]);
...
if(state_result_worm_ventral[llll][k_flappers][howmanyfluids_g].force_sign == 1)
{
	...
	result[3] = (F_total[0][llll][howmanyfluids_g][k_flappers]/mass_fluid_element+acc2_fluid[0][llll][howmanyfluids_g][k_flappers])/(1.0   );
	result[4] = (F_total[1][llll][howmanyfluids_g][k_flappers]/mass_fluid_element +acc2_fluid[1][llll][howmanyfluids_g][k_flappers]    )/(1.0   )-9.8;
	result[5] = (F_total[2][llll][howmanyfluids_g][k_flappers]/mass_fluid_element +acc2_fluid[2][llll][howmanyfluids_g][k_flappers])/(1.0); 
...
else if(state_result_worm_ventral[INDEX_NR][k_flappers][howmanyfluids_g].force_sign == -1)
{
    ...
    result[3] = -(F_total[0][INDEX_NR][howmanyfluids_g][k_flappers]/mass_fluid_element+acc2_fluid[0][INDEX_NR][howmanyfluids_g][k_flappers])/(1.0  );
    result[4] = -(F_total[1][INDEX_NR][howmanyfluids_g][k_flappers]/mass_fluid_element  +acc2_fluid[1][INDEX_NR][howmanyfluids_g][k_flappers] ) /(1.0) -9.8;
    result[5] = -(F_total[2][INDEX_NR][howmanyfluids_g][k_flappers]/mass_fluid_element +acc2_fluid[2][INDEX_NR][howmanyfluids_g][k_flappers])/(1.0  ); //522
...
else if(state_result_worm_ventral[INDEX_NRmore][k_flappers][howmanyfluids_g].force_sign == 1)
{
	...
	result[3] = (F_total[0][INDEX_NRmore][howmanyfluids_g][k_flappers]/mass_fluid_element+acc2_fluid[0][INDEX_NRmore][howmanyfluids_g][k_flappers])/(1.0   );
	result[4] = (F_total[1][INDEX_NRmore][howmanyfluids_g][k_flappers]/mass_fluid_element  +acc2_fluid[1][INDEX_NRmore][howmanyfluids_g][k_flappers] )/(1.0     )-9.8;
	result[5] = (F_total[2][INDEX_NRmore][howmanyfluids_g][k_flappers]/mass_fluid_element +acc2_fluid[2][INDEX_NRmore][howmanyfluids_g][k_flappers])/(1.0); 
...
int pressure_once = 1;
void calc_fluid_acceleration(int ll, int j,int xxx,int n)
{

	  density = (totalneigbours[ll][j] )*10;
if(density == 0)
density = 10;
//printf("total_molekules_nearby = %d :: density = %f\n", total_molekules_nearby,density);
...
void findnearestpoint_3_points_water_pressure(int points , int num,double r_collision, double **vvv,int ll, int j,int xxx )
{
   ...
   if(tdiff[ll][j] > ratiotime[ll][j] || INIT_ALLOCATE[ll] == 1    )
{
		
 if(tdiff[ll][j] > ratiotime[ll][j] && INIT_ALLOCATE[ll] == 0)
	tdiff[ll][j]= 0;
	int idx = ll ; 
	for( i=0; i<points; i++ ) {   
 
	int idx = i ; 
	ptree_______t[i]  = kd_create( 3 );
 
    	assert( 0 == kd_insert3( ptree_______t[i] , state_result_worm_ventral[i][xxx][j].pos_new_x, state_result_worm_ventral[i][xxx][j].pos_new_y, state_result_worm_ventral[i][xxx][j].pos_new_z, NULL ) );
...
else
{
	...
	presults = kd_nearest_range( ptree_______t[ll] , pt, radius );
 
 	  printf( "found %d results: :: pos x =%f\n", kd_res_size(presults), state_result_worm_ventral[ll][xxx][j].pos_new_x );
...
{
	int vn = ll;
	double distance_from_origin = sqrtf(powf( state_result_worm_ventral[ll][xxx][j].pos_new_x - 0 ,2.0) +  powf( state_result_worm_ventral[ll][xxx][j].pos_new_y -0 ,2.0)  + 				powf( state_result_worm_ventral[ll][xxx][j].pos_new_z -0 ,2.0  ));
 ...
 double sqrtthis2 = sqrtf(powf( state_result_worm_ventral[ll][xxx][j].pos_new_x - wall_info[n]->pos_new_x ,2.0) +  powf( state_result_worm_ventral[ll][xxx][j].pos_new_y - 	wall_info[n]->pos_new_y ,2.0)  + powf( state_result_worm_ventral[ll][xxx][j].pos_new_z - wall_info[n ]->pos_new_z ,2.0  ));


if(sqrtthis2 <1.5)
{
	double distance_from_origin_mini = sqrtf(powf( - state_result_worm_ventral[ll][xxx][j].pos_new_x    ,2.0) +  powf( state_result_worm_ventral[ll][xxx][j].pos_new_y-13.0   ,2.0)  + 				powf( state_result_worm_ventral[ll][xxx][j].pos_new_z -0 ,2.0  ));


double circle_distance_to_edge = sqrtf(powf((state_result_worm_ventral[ll][xxx][j].pos_new_x+0),2.0)+powf((state_result_worm_ventral[ll][xxx][j].pos_new_y-distance_from_origin_mini),2.0)  );
...
once_malloc_n = 0;
			...
			aa[0] = state_result_worm_ventral[ll][xxx][j].pos_new_x;
			aa[1] = state_result_worm_ventral[ll][xxx][j].pos_new_y;
                        aa[2] = state_result_worm_ventral[ll][xxx][j].pos_new_z;
...
//printf("neigbours_wall[n][0] = %d :: %d \n",neigbours_wall[n][0],neigbours_wall[n][2]);
  ...
  //printf("index2 = %d :: index3 = %d :: num = %d :: totalt antal grannar =%d :: KvvVENTAL2 =%d\n", neigbours_wall[n][index2], neigbours_wall[n][index3],n,totaln[n],KvvVENTAL2);
	 ...
	 */
 			vel[0] =  state_result_worm_ventral[ll][xxx][j].vel_new_x ;
			vel[1] = state_result_worm_ventral[ll][xxx][j].vel_new_y;
			vel[2] =state_result_worm_ventral[ll][xxx][j].vel_new_z;
...
//for(;;);
		...
		double sqrtthis = powf( state_result_worm_ventral[ll][xxx][j].pos_new_x - wall_info[neigbours_wall[n][index4]]->pos_new_x ,2.0) +  powf( state_result_worm_ventral[ll][xxx][j].pos_new_y - 	wall_info[neigbours_wall[n][index4]]->pos_new_y ,2.0)  + powf( state_result_worm_ventral[ll][xxx][j].pos_new_z - wall_info[neigbours_wall[n][index4]]->pos_new_z ,2.0  );
 ...
 if(fabs(normal[0]) > 0 && fabs(normal[1]) > 0 &&fabs(normal[2]) > 0 && xxxx < 1.5)
{
 
			state_result_worm_ventral[ll][xxx][j].vel_new_x  -=1.5*result3[0] ;
			state_result_worm_ventral[ll][xxx][j].vel_new_y  -=1.5*result3[1] ;
			state_result_worm_ventral[ll][xxx][j].vel_new_z  -=1.5*result3[2] ;
