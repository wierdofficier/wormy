...
int acc1once= 1;
void taskworm(int lllll, int *totalneigbours__,int *totalneigbourss__,struct state_vector ** state_result_worm_ventral_feather__,struct state_vector ** state_result_worm_ventral_feathers__, double ** F_total__,double ** F_totals__, struct state_vector  **state_result_worm_ventral__,struct state_vector  **state_result_worm_ventral_small__ )
{
 llll = lllll;
int k;
...
//{
	...
	//{
		...
		{	
						 ...
						 if(fabs(F_total__[0][INDEX_NR]) >  6   )
	 				 	  F_total__[0][INDEX_NR] =0;
 
		 		 if(fabs(F_total__[1][INDEX_NR])  >  6  )
						F_total__[1][INDEX_NR] =0;

			 	 if(fabs(F_total__[2][INDEX_NR])  >  6  )
						F_total__[2][INDEX_NR] =0;
  //printf("2totalneigbours__[lllll]  %d :: number %d :: index_____ = %d\n",totalneigbours__[lllll],lllll,INDEX_NR);
		...
		if ( r != 0  &&r < 1.1  && r > -1.1   )
		{
			...
			F_total__[0][INDEX_NR] +=( springVector->pos_new_x  /  r ) * ( r - springlength ) * ( -springConstant );
			F_total__[1][INDEX_NR] += ( springVector->pos_new_y /  r ) * ( r - springlength ) * ( -springConstant );
			F_total__[2][INDEX_NR] +=( springVector->pos_new_z  /  r ) * ( r - springlength ) * ( -springConstant );

			F_total__[0][lllll] +=( springVector->pos_new_x  / r ) * ( r - springlength ) * ( -springConstant );
			F_total__[1][lllll] += ( springVector->pos_new_y  / r ) * ( r - springlength) * ( -springConstant );
			F_total__[2][lllll] +=( springVector->pos_new_z  / r ) * ( r - springlength ) * ( -springConstant );

F_total__[0][INDEX_NR] +=-(  state_result_worm_ventral__[INDEX_NR]->vel_new_x - state_result_worm_ventral__[lllll]->vel_new_x ) * frictionConstant;
 		F_total__[1][INDEX_NR] += -( state_result_worm_ventral__[INDEX_NR]->vel_new_y- state_result_worm_ventral__[lllll]->vel_new_y ) * frictionConstant;
 		F_total__[2][INDEX_NR] += -(  state_result_worm_ventral__[INDEX_NR]->vel_new_z - state_result_worm_ventral__[lllll ]->vel_new_z ) * frictionConstant;


		F_total__[0][lllll] +=-(  state_result_worm_ventral__[INDEX_NR]->vel_new_x - state_result_worm_ventral__[lllll]->vel_new_x ) * frictionConstant;
 		F_total__[1][lllll] += -( state_result_worm_ventral__[INDEX_NR]->vel_new_y- state_result_worm_ventral__[lllll]->vel_new_y ) * frictionConstant;
 		F_total__[2][lllll] += -(  state_result_worm_ventral__[INDEX_NR]->vel_new_z - state_result_worm_ventral__[lllll ]->vel_new_z ) * frictionConstant;
...
if(state_result_worm_ventral__[INDEX_NR]->pos_new_y < -10)
			{
			 state_result_worm_ventral__[INDEX_NR]->pos_new_y = -10;
			 state_result_worm_ventral__[INDEX_NR]->vel_new_y = -state_result_worm_ventral__[INDEX_NR]->vel_new_y*0.00995;
 
			}	
		if(state_result_worm_ventral__[lllll]->pos_new_y < -10)
			{
				 state_result_worm_ventral__[lllll]->pos_new_y = -10;
...
{	 
 ...
 if(fabs(F_totals__[0][INDEX_NRs]) >  6   )
	 				 	  F_totals__[0][INDEX_NRs] =0;
 
		 		 if(fabs(F_totals__[1][INDEX_NRs])  >  6  )
						F_totals__[1][INDEX_NRs] =0;

			 	 if(fabs(F_totals__[2][INDEX_NRs])  >  6  )
						F_totals__[2][INDEX_NRs] =0;
springVector->pos_new_x = state_result_worm_ventral_small__[INDEX_NRs]->pos_new_x - state_result_worm_ventral__[lllll]->pos_new_x;
		...
		if ( r != 0  &&   r < 0.1   && r > -0.1   )
		{			
			F_totals__[0][INDEX_NRs] +=( springVector->pos_new_x  /  r ) * ( r - springlength ) * ( -springConstant );
			F_totals__[1][INDEX_NRs] += ( springVector->pos_new_y /  r ) * ( r - springlength ) * ( -springConstant );
			F_totals__[2][INDEX_NRs] +=( springVector->pos_new_z  /  r ) * ( r - springlength ) * ( -springConstant );
	// printf("TESTING\n");
			F_total__[0][lllll] +=( springVector->pos_new_x  / r ) * ( r - springlength ) * ( -springConstant );
			F_total__[1][lllll] += ( springVector->pos_new_y  / r ) * ( r - springlength) * ( -springConstant );
			F_total__[2][lllll] +=( springVector->pos_new_z  / r ) * ( r - springlength ) * ( -springConstant );

F_totals__[0][INDEX_NRs] +=-(  state_result_worm_ventral_small__[INDEX_NRs]->vel_new_x - state_result_worm_ventral__[lllll]->vel_new_x ) * frictionConstant;
 		F_totals__[1][INDEX_NRs] += -( state_result_worm_ventral_small__[INDEX_NRs]->vel_new_y- state_result_worm_ventral__[lllll]->vel_new_y ) * frictionConstant;
 		F_totals__[2][INDEX_NRs] += -(  state_result_worm_ventral_small__[INDEX_NRs]->vel_new_z - state_result_worm_ventral__[lllll ]->vel_new_z ) * frictionConstant;


		F_total__[0][lllll] +=-(  state_result_worm_ventral_small__[INDEX_NRs]->vel_new_x - state_result_worm_ventral__[lllll]->vel_new_x ) * frictionConstant;
 		F_total__[1][lllll] += -( state_result_worm_ventral_small__[INDEX_NRs]->vel_new_y- state_result_worm_ventral__[lllll]->vel_new_y ) * frictionConstant;
 		F_total__[2][lllll] += -(  state_result_worm_ventral_small__[INDEX_NRs]->vel_new_z - state_result_worm_ventral__[lllll ]->vel_new_z ) * frictionConstant;
	/*	state_result_worm_ventral__[lllll]->vel_new_x = state_result_worm_ventral__[lllll]->vel_new_x*0.999 ;
		
		state_result_worm_ventral__[lllll]->vel_new_y = state_result_worm_ventral__[lllll]->vel_new_y*0.999 ;

		state_result_worm_ventral__[lllll]->vel_new_z = state_result_worm_ventral__[lllll]->vel_new_z*0.999 ;

		state_result_worm_ventral_small__[INDEX_NRs]->vel_new_x = state_result_worm_ventral_small__[INDEX_NRs]->vel_new_x*0.999 ;
		
		state_result_worm_ventral_small__[INDEX_NRs]->vel_new_y = state_result_worm_ventral_small__[INDEX_NRs]->vel_new_y*0.999 ;
		state_result_worm_ventral_small__[INDEX_NRs]->vel_new_z = state_result_worm_ventral_small__[INDEX_NRs]->vel_new_z*0.999 ;*/
BIGONE = 0;
...
if(state_result_worm_ventral_small__[INDEX_NRs]->pos_new_y < -10)
			{
			 state_result_worm_ventral_small__[INDEX_NRs]->pos_new_y = -10;
...
INDEX_NRmore = state_result_worm_ventral_feather__[lllll][d].INDEX_NR;
				 ...
				 if(fabs(F_total__[0][INDEX_NRmore]) >  6   )
	 				  F_total__[0][INDEX_NRmore] =0;
 
		 		 if(fabs(F_total__[1][INDEX_NRmore])  >  6  )
					  F_total__[1][INDEX_NRmore] =0;

			 	 if(fabs(F_total__[2][INDEX_NRmore])  >  6  )
					  F_total__[2][INDEX_NRmore] =0;
	...
	//	 printf("1totalneigbours[lllll]  %d :: number %d :: index_____ = %d\n",totalneigbours[lllll],lllll,INDEX_NRmore);	
			...
			F_total__[0][INDEX_NRmore] +=( springVector->pos_new_x  / r ) * ( r - springlength ) * ( -springConstant );
			F_total__[1][INDEX_NRmore] += ( springVector->pos_new_y  / r ) * ( r - springlength) * ( -springConstant );
			F_total__[2][INDEX_NRmore] +=( springVector->pos_new_z  / r ) * ( r - springlength ) * ( -springConstant );

		F_total__[0][INDEX_NR] +=-(  state_result_worm_ventral__[INDEX_NR]->vel_new_x - state_result_worm_ventral__[INDEX_NRmore]->vel_new_x ) * frictionConstant;
 		F_total__[1][INDEX_NR] += -( state_result_worm_ventral__[INDEX_NR]->vel_new_y- state_result_worm_ventral__[INDEX_NRmore]->vel_new_y ) * frictionConstant;
 		F_total__[2][INDEX_NR] += -(  state_result_worm_ventral__[INDEX_NR]->vel_new_z - state_result_worm_ventral__[INDEX_NRmore ]->vel_new_z ) * frictionConstant;


		F_total__[0][INDEX_NRmore] +=-(  state_result_worm_ventral__[INDEX_NR]->vel_new_x - state_result_worm_ventral__[INDEX_NRmore]->vel_new_x ) * frictionConstant;
 		F_total__[1][INDEX_NRmore] += -( state_result_worm_ventral__[INDEX_NR]->vel_new_y- state_result_worm_ventral__[INDEX_NRmore]->vel_new_y ) * frictionConstant;
 		F_total__[2][INDEX_NRmore] += -(  state_result_worm_ventral__[INDEX_NR]->vel_new_z - state_result_worm_ventral__[INDEX_NRmore ]->vel_new_z ) * frictionConstant;
...
if(state_result_worm_ventral__[INDEX_NR]->pos_new_y < -10)
		...
		if(state_result_worm_ventral__[INDEX_NRmore]->pos_new_y < -10)
			{
				 state_result_worm_ventral__[INDEX_NRmore]->pos_new_y = -10;
...
INDEX_NRmores = state_result_worm_ventral_feathers__[lllll][d].INDEX_NR;
			...
			if(fabs(F_totals__[0][INDEX_NRmores]) >  6   )
	 				  F_totals__[0][INDEX_NRmores] =0;
 
		 		 if(fabs(F_totals__[1][INDEX_NRmores])  >  6  )
					  F_totals__[1][INDEX_NRmores] =0;

			 	 if(fabs(F_totals__[2][INDEX_NRmores])  >  6  )
					  F_totals__[2][INDEX_NRmores] =0;
...
springVector->pos_new_x = state_result_worm_ventral__[INDEX_NR]->pos_new_x - state_result_worm_ventral_small__[INDEX_NRmores]->pos_new_x;
	...
	//	 printf("1totalneigbours[lllll]  %d :: number %d :: index_____ = %d\n",totalneigbours[lllll],lllll,INDEX_NRmore);	
			...
			F_totals__[0][INDEX_NRmores] +=( springVector->pos_new_x  / r ) * ( r - springlength ) * ( -springConstant );
			F_totals__[1][INDEX_NRmores] += ( springVector->pos_new_y  / r ) * ( r - springlength) * ( -springConstant );
			F_totals__[2][INDEX_NRmores] +=( springVector->pos_new_z  / r ) * ( r - springlength ) * ( -springConstant );

		F_total__[0][INDEX_NR] +=-(  state_result_worm_ventral__[INDEX_NR]->vel_new_x - state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_x ) * frictionConstant;
 		F_total__[1][INDEX_NR] += -( state_result_worm_ventral__[INDEX_NR]->vel_new_y- state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_y ) * frictionConstant;
 		F_total__[2][INDEX_NR] += -(  state_result_worm_ventral__[INDEX_NR]->vel_new_z - state_result_worm_ventral_small__[INDEX_NRmores ]->vel_new_z ) * frictionConstant;


		F_totals__[0][INDEX_NRmores] +=-(  state_result_worm_ventral__[INDEX_NR]->vel_new_x - state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_x ) * frictionConstant;
 		F_totals__[1][INDEX_NRmores] += -( state_result_worm_ventral__[INDEX_NR]->vel_new_y- state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_y ) * frictionConstant;
 		F_totals__[2][INDEX_NRmores] += -(  state_result_worm_ventral__[INDEX_NR]->vel_new_z - state_result_worm_ventral_small__[INDEX_NRmores ]->vel_new_z ) * frictionConstant;

	/*	state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_x = state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_x*0.999 ;
		
		state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_y = state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_y*0.999 ;

		state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_z = state_result_worm_ventral_small__[INDEX_NRmores]->vel_new_z*0.999 ;

		state_result_worm_ventral__[INDEX_NR]->vel_new_x = state_result_worm_ventral__[INDEX_NR]->vel_new_x*0.999 ;
		
		state_result_worm_ventral__[INDEX_NR]->vel_new_y = state_result_worm_ventral__[INDEX_NR]->vel_new_y*0.999 ;
		state_result_worm_ventral__[INDEX_NR]->vel_new_z = state_result_worm_ventral__[INDEX_NR]->vel_new_z*0.999 ;*/
BIGONE = 1;
		state_result_worm_ventral__[INDEX_NR]->force_sign =  -1;
		state_result_worm_ventral__[INDEX_NR]    =  worm_ventral(  state_result_worm_ventral__[INDEX_NR] ,1) ;
BIGONE = 0;
...
if(state_result_worm_ventral__[INDEX_NR]->pos_new_y < -10)
		...
		if(state_result_worm_ventral_small__[INDEX_NRmores]->pos_new_y < -10)
			{
				 state_result_worm_ventral_small__[INDEX_NRmores]->pos_new_y = -10;
...
//}
		 ...
		 if(fabs(F_total__[0][lllll]) >  6   )
	 				 F_total__[0][lllll] =0;
 
		 		 if(fabs(F_total__[1][lllll])  >  6  )
					 F_total__[1][lllll] =0;

			 	 if(fabs(F_total__[2][lllll])  >  6  )
					 F_total__[2][lllll] =0;
...
BIGONE = 1;
  taskworm(ll, totalneigbours, totalneigbourss, state_result_worm_ventral_feather,state_result_worm_ventral_feathers,  F_total,  F_totals,  state_result_worm_ventral, state_result_worm_ventral_small );

BIGONE = 1;
 taskworm(ll, totalneigbourss, totalneigbours, state_result_worm_ventral_feathers,state_result_worm_ventral_feather ,  F_totals,  F_total,  state_result_worm_ventral_small, state_result_worm_ventral);
//taskworm();
...
if(state_result_worm_ventral[llll]->force_sign == 1)
{
	...
	result[3] = (F_total[0][llll])/(42222.0   );
	result[4] = (F_total[1][llll]   )/(42222.0   );
	result[5] = (F_total[2][llll] )/(42222.0); 
...
else if(state_result_worm_ventral[INDEX_NR]->force_sign == -1)
{
    ...
    result[3] = -(F_total[0][INDEX_NR])/(42222.0);
    result[4] = -(F_total[1][INDEX_NR]  ) /(42222.0) ;
    result[5] = -(F_total[2][INDEX_NR] )/(42222.0); //522
...
else if(state_result_worm_ventral[INDEX_NRmore]->force_sign == 1)
{
	...
	result[3] = (F_total[0][INDEX_NRmore])/(42222.0   );
	result[4] = (F_total[1][INDEX_NRmore]  )/(42222.0  );
	result[5] = (F_total[2][INDEX_NRmore] )/(42222.0); 
...
if(state_result_worm_ventral[llll]->force_sign == 1)
{
	...
	result[3] = (F_total[0][llll])/(42222.0   );
	result[4] = (F_total[1][llll]  -9.8  )/(42222.0   );
	result[5] = (F_total[2][llll] )/(42222.0); 
 ...
 else if(state_result_worm_ventral_small[INDEX_NRs]->force_sign == -1)
{
    ...
    result[3] = -(F_totals[0][INDEX_NRs])/(42222.0);
    result[4] = -(F_totals[1][INDEX_NRs]  -9.8 ) /(42222.0) ;
    result[5] = -(F_totals[2][INDEX_NRs] )/(42222.0); //522
...
else if(state_result_worm_ventral_small[INDEX_NRmores]->force_sign == 1)
{
	...
	result[3] = (F_totals[0][INDEX_NRmores])/(42222.0   );
	result[4] = (F_totals[1][INDEX_NRmores]   -9.8 )/(42222.0  );
	result[5] = (F_totals[2][INDEX_NRmores] )/(42222.0); 
