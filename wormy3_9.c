...
{
    	result[0] =             state_result_worm_ventral[llll][k_flappers][howmanyfluids_g].vel_new_x/200.0;
    	result[1] =             state_result_worm_ventral[llll][k_flappers][howmanyfluids_g].vel_new_y/200.0;
    	result[2] =             state_result_worm_ventral[llll][k_flappers][howmanyfluids_g].vel_new_z/200.0;
  
	result[3] = (F_total[0][llll][howmanyfluids_g][k_flappers]+acc2_fluid[0][llll][howmanyfluids_g][k_flappers])/(200.0   );
	result[4] = (F_total[1][llll][howmanyfluids_g][k_flappers] +acc2_fluid[1][llll][howmanyfluids_g][k_flappers] - 9.8 )/(200.0   );
	result[5] = (F_total[2][llll][howmanyfluids_g][k_flappers] +acc2_fluid[2][llll][howmanyfluids_g][k_flappers])/(200.0); 

 
}
else if(state_result_worm_ventral[INDEX_NR][k_flappers][howmanyfluids_g].force_sign == -1)
{
    result[0] =             state_result_worm_ventral[INDEX_NR][k_flappers][howmanyfluids_g].vel_new_x/200.0;
    result[1] =             state_result_worm_ventral[INDEX_NR][k_flappers][howmanyfluids_g].vel_new_y/200.0;
    result[2] =             state_result_worm_ventral[INDEX_NR][k_flappers][howmanyfluids_g].vel_new_z/200.0;
  
    result[3] = -(F_total[0][INDEX_NR][howmanyfluids_g][k_flappers]+acc2_fluid[0][INDEX_NR][howmanyfluids_g][k_flappers])/(200.0  );
    result[4] = -(F_total[1][INDEX_NR][howmanyfluids_g][k_flappers]  +acc2_fluid[1][INDEX_NR][howmanyfluids_g][k_flappers]- 9.8) /(200.0) ;
    result[5] = -(F_total[2][INDEX_NR][howmanyfluids_g][k_flappers] +acc2_fluid[2][INDEX_NR][howmanyfluids_g][k_flappers])/(200.0  ); //522
 

}
else if(state_result_worm_ventral[INDEX_NRmore][k_flappers][howmanyfluids_g].force_sign == 1)
{
    	result[0] =             state_result_worm_ventral[INDEX_NRmore][k_flappers][howmanyfluids_g].vel_new_x/200.0;
    	result[1] =             state_result_worm_ventral[INDEX_NRmore][k_flappers][howmanyfluids_g].vel_new_y/200.0;
    	result[2] =             state_result_worm_ventral[INDEX_NRmore][k_flappers][howmanyfluids_g].vel_new_z/200.0;
  
	result[3] = (F_total[0][INDEX_NRmore][howmanyfluids_g][k_flappers]+acc2_fluid[0][INDEX_NRmore][howmanyfluids_g][k_flappers])/(200.0   );
	result[4] = (F_total[1][INDEX_NRmore][howmanyfluids_g][k_flappers]  +acc2_fluid[1][INDEX_NRmore][howmanyfluids_g][k_flappers]- 9.8 )/(200.0     );
	result[5] = (F_total[2][INDEX_NRmore][howmanyfluids_g][k_flappers] +acc2_fluid[2][INDEX_NRmore][howmanyfluids_g][k_flappers])/(200.0); 
...
void calc_fluid_velocity(int ll, int j, int xxx)
{
	...
	if(( fabs(distance_from_origin)) < 9 || fabs(distance_from_origin) > (12.5))
 	{
		...
		if( fabs(xxxx) > 0 &&  fabs(xxxx) <4)
		{
			...
			findnearestpoint_3_points(KvvVENTAL2      ,   ll, fabs(xxxx)/1.0, wall_info ,ll,j);
			...
			bb[0] = neighbourV_[0][0];
			bb[1] = neighbourV_[0][1];
                        bb[2] = neighbourV_[0][2];


			cc[0] = neighbourV_[1][0];
			cc[1] = neighbourV_[1][1];
                        cc[2] = neighbourV_[1][2];
			...
			vel[2] =state_result_worm_ventral[ll][j]->vel_new_z;
 			...
 			double * cross = malloc(100) ;
			double *dir1 = malloc(20);
			double *dir2 =malloc(20);
			//v′ = f w − r u
			double r =1;
			...
			result[1] = pos_new[1] - cc[1];
			result[2] = pos_new[2] - cc[2];
 			calculate_normal(aa ,bb ,cc ,normal);
 
			double *result2 = malloc(20);
			...
			state_result_worm_ventral[ll][k_flappers][j].vel_new_x  -=result3[0] ;
			state_result_worm_ventral[ll][k_flappers][j].vel_new_y  -=result3[1] ;
			state_result_worm_ventral[ll][k_flappers][j].vel_new_z  -=result3[2] ;
 			taskworm(j,ll,xxx);
			free(result2);
			free(result);
			free(pos_new);
