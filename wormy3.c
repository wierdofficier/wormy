...
if(state_result_worm_ventral[llll]->force_sign == 1)
{
	...
	result[3] = (F_total[0][llll])/(40000.0   );
	result[4] = (F_total[1][llll]   )/(40000.0   );
	result[5] = (F_total[2][llll] )/(40000.0); 
...
else if(state_result_worm_ventral[INDEX_NR]->force_sign == -1)
{
    ...
    result[3] = -(F_total[0][INDEX_NR])/(40000.0  );
    result[4] = -(F_total[1][INDEX_NR]  ) /(40000.0) ;
    result[5] = -(F_total[2][INDEX_NR] )/(40000.0  ); //522
...
else if(state_result_worm_ventral[INDEX_NRmore]->force_sign == 1)
{
	...
	result[3] = (F_total[0][INDEX_NRmore])/(400.0   );
	result[4] = (F_total[1][INDEX_NRmore] -9.8  )/(400.0   );
	result[5] = (F_total[2][INDEX_NRmore] )/(400.0); 
